...
MBED_WEAK const PinMap PinMap_SPI_SSEL[] = {
    ...
    {PA_4,       SPI_1, STM_PIN_DATA(STM_MODE_OUTPUT_PP, GPIO_NOPULL, 0)},  // SD_CS
    {PC_4,       SPI_1, STM_PIN_DATA(STM_MODE_OUTPUT_PP, GPIO_NOPULL, 0)},  // DRIVER0_CS
    {PD_11,      SPI_1, STM_PIN_DATA(STM_MODE_OUTPUT_PP, GPIO_NOPULL, 0)},  // DRIVER1_CS
    {PC_6,       SPI_1, STM_PIN_DATA(STM_MODE_OUTPUT_PP, GPIO_NOPULL, 0)},  // DRIVER2_CS
    {PC_7,       SPI_1, STM_PIN_DATA(STM_MODE_OUTPUT_PP, GPIO_NOPULL, 0)},  // DRIVER3_CS
    {PF_2,       SPI_1, STM_PIN_DATA(STM_MODE_OUTPUT_PP, GPIO_NOPULL, 0)},  // DRIVER4_CS
    {PE_4,       SPI_1, STM_PIN_DATA(STM_MODE_OUTPUT_PP, GPIO_NOPULL, 0)},  // DRIVER5_CS
    {PE_1,       SPI_1, STM_PIN_DATA(STM_MODE_OUTPUT_PP, GPIO_NOPULL, 0)},  // DRIVER6_CS
    {PD_3,       SPI_1, STM_PIN_DATA(STM_MODE_OUTPUT_PP, GPIO_NOPULL, 0)},  // DRIVER7_CS
    {PF_8,       SPI_1, STM_PIN_DATA(STM_MODE_OUTPUT_PP, GPIO_NOPULL, 0)},  // MAX31865_CS
    // SPI2 - Auxiliary
    {PB_12,      SPI_2, STM_PIN_DATA(STM_MODE_OUTPUT_PP, GPIO_NOPULL, 0)},  // SPI2_NSS
    // SPI3 - Display
...
MBED_WEAK const PinMap PinMap_DEBUG[] = {
    {PA_13_ALT0,      DEBUG_JTMS_SWDIO, STM_PIN_DATA(STM_MODE_AF_PP, GPIO_PULLUP, GPIO_AF0_SWJ)},    // SWDIO/WORK_LED
    {PA_14_ALT0,  DEBUG_JTCK_SWCLK, STM_PIN_DATA(STM_MODE_AF_PP, GPIO_PULLUP, GPIO_AF0_SWJ)},    // SWCLK
    {PA_15_ALT0,  DEBUG_JTDI,       STM_PIN_DATA(STM_MODE_AF_PP, GPIO_PULLUP, GPIO_AF0_SWJ)},    // JTDI/SPI3_NSS
    {PB_3_ALT0,   DEBUG_JTDO_SWO,   STM_PIN_DATA(STM_MODE_AF_PP, GPIO_PULLUP, GPIO_AF0_SWJ)},    // SWO
    {PB_4_ALT0,   DEBUG_JTRST,      STM_PIN_DATA(STM_MODE_AF_PP, GPIO_PULLUP, GPIO_AF0_SWJ)},    // JTRST
    {NC, NC, 0}
};
