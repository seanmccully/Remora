...
public:
     ...
     *
     *  @param fs       SDFilesystem as target for the file
     *  @param path     The name of the file to open
     *  @param flags    The flags to open the file in, one of O_RDONLY, O_WRONLY, O_RDWR,
     *                  bitwise or'd with one of O_CREAT, O_TRUNC, O_APPEND
     */
    SDFile(const char *path, int flags = O_RDONLY);
    SDFile(FATFileSystem *fs, const char *path, int flags = O_RDONLY);
    ...
    int open(FATFileSystem *fs, const char *path, int flags = O_RDONLY);
    bool is_open();
